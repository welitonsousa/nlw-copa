...
import 'package:mobile/modules/poll/details/details_bindings.dart';
import 'package:mobile/modules/poll/details/details_page.dart';
...
class Pages {
  ...
  final list = <GetPage>[
    ...
    GetPage(
      name: NamesRouters.POOL_DETAILS,
